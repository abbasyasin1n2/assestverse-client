...
const MobileSidebar = ({ isOpen, onClose }) => {
  ...
  const employeeLinks = [
    ...
    { to: "/dashboard/employee-profile", icon: FiUser, label: "Profile" },
  ];
  ...
  const hrLinks = [
    ...
    { to: "/dashboard/employee-list", icon: FiUsers, label: "My Employees" },
    { to: "/dashboard/upgrade-package", icon: FiCreditCard, label: "Upgrade Package" },
    { to: "/dashboard/hr-profile", icon: FiUser, label: "Profile" },
  ];
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className="fixed left-0 top-0 h-full w-64 bg-base-100 z-50 lg:hidden overflow-y-auto shadow-xl">
        <div className="p-4">
          {/* Header */}
